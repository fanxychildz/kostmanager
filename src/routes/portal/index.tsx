...
function PortalDashboard() {
  ...
  const loadAnnouncements = async (): Promise<PortalAnnouncement[]> => {
    try {
  ...
  const handleCreateAnnouncement = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const announcementsList = await loadAnnouncements()
