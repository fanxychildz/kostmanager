  ...
  return (
    <DashboardBootstrap>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* Filter Pills */}
        <div className="grid grid-cols-2 sm:flex sm:flex-row gap-1.5 w-full pb-1 md:pb-0">
          {([
            { id: 'all', label: 'Semua' },
            ...
            <button
              ...
              disabled={isBusy}
              className={`px-3 py-1.5 rounded-lg text-xs font-bold border transition text-center w-full sm:w-auto ${
                filter === opt.id 
